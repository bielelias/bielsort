...
## Version 0.2 `sort(key=...)`

Version 0.2 connects the existing new-list `key` parameter to the
...
The in-place keyed experiment was rejected for this release: despite large
